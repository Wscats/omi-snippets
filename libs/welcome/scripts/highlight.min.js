...
!function(e) {
    ...
    function _(e) {
        ...
        return function e(t, r) {
            for (var a = t.firstChild; a; a = a.nextSibling)
                ...
                r = e(a, r),
                f(a).match(/br|hr|img|input/) || n.push({
                    event: "stop",
                    offset: r,
                    node: a
                }));
                ...
                r.t = i.length ? c(function(e, t) {
                    for (var r = /\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./, a = 0, n = "", i = 0; i < e.length; i++) {
                        ...
                        for (0 < i && (n += t); 0 < c.length; ) {
                            ...
                            "\\" == o[0][0] && o[1] ? n += "\\" + String(Number(o[1]) + s) : (n += o[0],
                            "(" == o[0] && a++)
                        }
                    }
                    return n
    ...
    function k(e, t, c, r) {
        ...
        function l() {
            p += null != b.sL ? function() {
                ...
                r = b.lR.exec(m); r; )
                    ...
                    (e = n.k.hasOwnProperty(s) && n.k[s]) ? (f += e[1],
                    a += o(e[0], y(r[0]))) : a += y(r[0]),
                    t = b.lR.lastIndex,
                    r = b.lR.exec(m);
        ...
        function a(e, t) {
            ...
            var r = function(e, t) {
                ...
                a = t.c.length; r < a; r++)
                    if (w(t.c[r].bR, e))
                        return t.c[r].endSameAsBegin && (t.c[r].eR = (n = t.c[r].bR.exec(e)[0],
                        new RegExp(n.replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&"),"m"))),
                        t.c[r]
            }(t, b);
            if (r)
                return r.skip ? m += t : (r.eB && (m += t),
                l(),
                r.rB || r.eB || (m = t)),
                u(r),
                r.rB ? 0 : t.length;
            ...
            if (i) {
                var s = b;
                for (s.skip ? m += t : (s.rE || s.eE || (m += t),
                l(),
                s.eE && (m = t)); b.cN && (p += N),
                b.skip || b.sL || (f += b.r),
                (b = b.parent) !== i.parent; )
                    ;
                return i.starts && (i.endSameAsBegin && (i.starts.eR = i.eR),
                u(i.starts)),
                s.rE ? 0 : t.length
            }
            if (a = t,
            n = b,
            !c && w(n.iR, a))
                throw new Error('Illegal lexeme "' + t + '" for mode "' + (b.cN || "<unnamed>") + '"');
            return m += t,
            t.length || 1
        }
        var d = C(e);
        ...
        E(d);
        var n, b = r || d, i = {}, p = "";
        for (n = b; n !== d; n = n.parent)
            n.cN && (p = o(n.cN, "", !0) + p);
        var m = ""
          , f = 0;
        try {
            for (var s, g, _ = 0; b.t.lastIndex = _,
            s = b.t.exec(t); )
                g = a(t.substring(_, s.index), s[0]),
                _ = s.index + g;
            for (a(t.substr(_)),
            n = b; n.parent; n = n.parent)
                n.cN && (p += N);
            return {
                r: f,
                value: p,
    ...
    function s(e) {
        ...
        i = t.textContent,
        a = d ? k(d, i, !0) : x(i),
        (r = _(t)).length && ((n = document.createElementNS("http://www.w3.org/1999/xhtml", "div")).innerHTML = a.value,
        a.value = function(e, t, r) {
            ...
            for (; e.length || t.length; ) {
                var u = s();
                if (n += y(r.substring(a, u[0].offset)),
                a = u[0].offset,
                u === e) {
                    for (i.reverse().forEach(o); l(u.splice(0, 1)[0]),
    ...
    n.registerLanguage("cs", function(e) {
        ...
        s.c = [l, c, n, e.ASM, e.QSM, r, e.inherit(e.CBCM, {
            i: /\n/
        })];
        var u = {
            v: [o, c, a, e.ASM, e.QSM]
