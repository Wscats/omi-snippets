...
const emptyObject_1 = emptyObject;
...

{
  ...
  lowPriorityWarning = function (condition, format) {
    ...
    if (!condition) {
      for (let _len2 = arguments.length, args = Array(_len2 > 2 ? _len2 - 2 : 0), _key2 = 2; _key2 < _len2; _key2++) {
...
const emptyFunction_1 = emptyFunction;
...
let warning = emptyFunction_1;

{
  var printWarning$1 = function printWarning(format) {
    for (const _len = arguments.length, args = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
      args[_key - 1] = arguments[_key];
    }
  ...
  warning = function warning(condition, format) {
    ...
    if (!condition) {
      for (const _len2 = arguments.length, args = Array(_len2 > 2 ? _len2 - 2 : 0), _key2 = 2; _key2 < _len2; _key2++) {
        args[_key2 - 2] = arguments[_key2];
      }
...
function cloneAndReplaceKey(oldElement, newKey) {
  let newElement = ReactElement(oldElement.type, newKey, oldElement.ref, oldElement._self, oldElement._source, oldElement._owner, oldElement.props);
...
function cloneElement(element, config, children) {
  ...
  const propName = void 0;

  // Original props are copied
  const props = objectAssign({}, element.props);
...
function traverseAllChildrenImpl(children, nameSoFar, callback, traverseContext) {
  ...
  let child = void 0;
  let nextName = void 0;
  const subtreeCount = 0; // Count of children found in the current subtree.
